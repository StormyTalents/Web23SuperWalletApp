...
const CreatePostNFTScreen: React.FC = () => {
    ...
    <>
                ...
                {isUploading.state !== 'pending' ? (
                  <View
                    ...
                    <View
                      ...
                      <Text style={tw`mb-2 text-base text-center text-grey-50`}>
                        {t('Uploading') + '...'}
                      </Text>
          ...
          <TouchableOpacity
            ...
            <View style={tw`flex flex-row items-center gap-3`}>
              ...
              <View style={tw`py-1 font-bold`}>
                ...
                <Text style={tw`text-xs text-grey-400`}>
                  {additional.external || 'Not added yet'}
                </Text>
              </View>
            </View>
            <View>
          ...
          <TouchableOpacity
            ...
            <View style={tw`flex flex-row items-center gap-3`}>
              ...
              <View style={tw`py-1 font-bold`}>
                ...
                <Text style={tw`text-xs text-grey-400`}>
                  {additional.alternate || 'Not added yet'}
                </Text>
              </View>
            </View>
            <View>
        ...
        <View style={tw`mb-4 bg-grey-900 rounded-xl`}>
          ...
          <View style={tw`p-4 font-bold border-b border-b-grey-800`}>
            ...
            attributes[attributes.length - 1].value !== '' ? (
              ...
              <>
                <Text style={tw`mt-1 mb-2 text-base text-center text-grey-50`}>
                  {t('Not added yet')}
                </Text>
                <Text style={tw`px-10 mb-1 text-xs text-center text-grey-600`}>
          ...
          <View style={tw`flex flex-row justify-center gap-3 p-3`}>
            <TouchableOpacity
              ...
              <View style={tw`flex flex-col justify-center`}>
                <View style={tw`flex flex-row justify-center`}>
                  <View
                    style={tw`flex flex-row items-center justify-center w-12 h-12 rounded-full bg-grey-800`}>
            ...
            <TouchableOpacity
              ...
              <View style={tw`flex flex-col justify-center`}>
                <View style={tw`flex flex-row justify-center`}>
                  <View
                    style={tw`flex flex-row items-center justify-center w-12 h-12 rounded-full bg-grey-800`}>
                    <SpaSVG fill={tab === 2 ? '#D7FC51' : '#9E9E9E'} />
                  </View>
                </View>
                <Text style={tw`text-base font-bold text-center text-white`}>
                  {t('Not for Sale')}
          ...
          {tab === 1 && (
            <View style={tw`px-3 pb-4`}>
              ...
              <View style={tw`flex flex-col gap-4`}>
                <Web23Input
                  placeholder={t('Auction start time (IST)')}
                ...
                />
                <Web23Input
                  placeholder={t('Auction end time (IST)')}
      ...
      <Web23Popup
        ...
        <View
          ...
          <Web23Input
            ...
            onChange={e => setAdditional({...additional, alternate: e})}
          />
        </View>
      </Web23Popup>
      <Web23Popup
      ...
      <Web23Popup
        ...
        <View style={tw`flex flex-col gap-4 mb-4`}>
          ...
          <View style={tw`rounded-xl bg-grey-900`}>
            <Text
          ...
          <View
            ...
            <Text style={tw`flex`}>{t('Transaction Fees')}</Text>
            ...
            onPress={async () => {
              try {
                ...
                await apiHandler('create_nft', currentUser.token, {
                  ...
                  externalLink: additional.external,
                  alternate: additional.alternate,
...
export default CreatePostNFTScreen;
